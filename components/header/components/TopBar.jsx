...
export default function TopBar() {
  return (
    <div class="top-bar py-3 bg-indigo-950">
    <div class="max-w-[1460px] mx-auto px-4 text-sm">
        <div class="flex flex-col items-center md:flex-row md:items-start md:justify-between text-white">
