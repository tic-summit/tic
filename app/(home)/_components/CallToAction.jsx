...
export default function CallToAction() {
    return (
        ...
        // </div>
        <>
            <div className='flex  flex-nowrap items-center h-[720px] w-full sm:h-full'>
                <div className="h-[720px] max-[900px]:w-full min-[900px]:w-[50%] bg-brand/5  flex flex-col justify-center  items-end">
                    <div className=' my-auto px-4 lg:pr-20 w-full min-[1112px]:w-[90%] min-[1660px]:w-[68%] '>
                        <h2 className='font-semibold  sm:text-2xl text-gray-700'>What are you waiting for?</h2>
                        <h3 className='text-gray-600 text-lg sm:text-xl'>Everyone wants to propel to the next level.</h3>
                ...
                <div className='hidden min-[900px]:block w-[842px]'>  
                     <img src="/hero.png" alt="" className=' object-center object-contain w-full h-[842px] ml-12 border rounded-full' />
                </div>
            </div>
        </>
    )
