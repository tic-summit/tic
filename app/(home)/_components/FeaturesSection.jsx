...
export default function FeaturesSection() {
  const features = [
    {
      icon: <Icon icon="solar:book-outline" className="w-8 h-8 text-brand" />,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="grou relative bg-white rounded-2xl p-8  transition-all duration-300 border border-brand"
            >
              ...
              <div className="relative z-10">
                <div className="bg-gradient-to-br from-brand/10 to-brand/5 p-4 rounded-xl w-fit mb-6 ">
                  {feature.icon}
                </div>
