        ...
        <div className='bg-[#f1f0f8]'>
            ...
            <div className=''>
                <div className='max-w-[1500px] mx-auto'>
                    <div className='grid grid-cols-1 md:grid-cols-2 h-[calc(70vh-6rem)]  md:h-[calc(95vh-6rem)] gap-4  items-center pl-4 '>
                        <div className="letf-section">
                        ...
                        <div className="hidden md:block right-section  h-full ">
